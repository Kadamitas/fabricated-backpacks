...
public final class SteamEngineMenus {
    public static final ExtendedScreenHandlerType<SteamEngineMenu, BlockPos> STEAM_ENGINE = Registry.register(BuiltInRegistries.MENU,
            ResourceLocation.fromNamespaceAndPath("fabricated_backpacks", "steam_engine"),
            new ExtendedScreenHandlerType<>(SteamEngineMenu::new, BlockPos.STREAM_CODEC));
    public static final ExtendedScreenHandlerType<SteamEngineSideMenu, BlockPos> SIDES = Registry.register(BuiltInRegistries.MENU,
            ResourceLocation.fromNamespaceAndPath("fabricated_backpacks", "steam_engine_sides"),
            new ExtendedScreenHandlerType<>(SteamEngineSideMenu::new, BlockPos.STREAM_CODEC));
    ...
    public static boolean openSides(ServerPlayer player, SteamEngineBlockEntity engine, Direction face) {
        ...
        return player.openMenu(new ExtendedScreenHandlerFactory<BlockPos>() {
