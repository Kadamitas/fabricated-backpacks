...
public final class SteamEngineComponents {
    public static final DataComponentType<SteamEngineState> STATE = com.kadamitas.fabricatedbackpacks.platform.NativeRegistries.register(BuiltInRegistries.DATA_COMPONENT_TYPE,
    ...
    public static final DataComponentType<SteamEngineSides> SIDES = com.kadamitas.fabricatedbackpacks.platform.NativeRegistries.register(BuiltInRegistries.DATA_COMPONENT_TYPE,
