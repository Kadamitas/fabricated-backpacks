...
public final class ResourceComponents {
    ...
    public static final DataComponentType<FluidVariant> TANK_FLUID = com.kadamitas.fabricatedbackpacks.platform.NativeRegistries.register(
    ...
    public static final DataComponentType<List<FluidVariant>> VOID_FLUID_FILTERS = com.kadamitas.fabricatedbackpacks.platform.NativeRegistries.register(
    ...
    public static final Fluid EXPERIENCE = com.kadamitas.fabricatedbackpacks.platform.NativeRegistries.register(BuiltInRegistries.FLUID,
