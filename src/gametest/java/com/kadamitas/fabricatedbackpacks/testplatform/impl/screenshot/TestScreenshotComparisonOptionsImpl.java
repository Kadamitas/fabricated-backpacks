...
package com.kadamitas.fabricatedbackpacks.testplatform.impl.screenshot;
...
import com.kadamitas.fabricatedbackpacks.testplatform.impl.NativeClientGameTestRunner;
...
public final class TestScreenshotComparisonOptionsImpl extends TestScreenshotCommonOptionsImpl<TestScreenshotComparisonOptions> implements TestScreenshotComparisonOptions {
	...
	private static NativeImage loadNativeImage(String templateImagePath) {
		try (InputStream stream = NativeClientGameTestRunner.currentlyRunningGameTest.getClass().getClassLoader()
				.getResourceAsStream("templates/" + templateImagePath + ".png")) {
