...
Historical upstream record imported with the 0.5.2 fixes. These results are for
the exact Minecraft 26.2 artifact below, not this branch's Minecraft 1.21.1 port
or its planned 1.0.0 release. Use the target-specific compatibility workflow
for fresh results on this branch.
