...
Upgradeable wearable backpacks for **Minecraft 26.2 on Fabric**.

Carry a backpack alongside your chest armor, place it in the world, and choose
the upgrades that suit your trip. Six tiers provide 27 to 120 storage cells by
default, with colors, remembered slots, sorting, search and a selected-item
display on the outside.

## Build your backpack

- Collect and move items with pickup, magnet, deposit, restock and refill upgrades.
...
The built-in equipment panel and recipe browser need no separate accessory or
recipe-viewer mod. The browser provides recipes, uses, search, bookmarks, ghost
filter selection and ingredient transfer into compatible open workstations.

Backpacks use original 3D models with separate body and trim colors, material
fittings, worn rendering and animated placed lids.

## Install and start

Requires **Minecraft Java Edition 26.2**, **Java 25**, **Fabric Loader 0.19.3+**
and **Fabric API 0.158.0+26.2** or a newer compatible 26.2 build. The Energy API is included.
